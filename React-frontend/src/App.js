  ...
  return (
    <div className="containerBI">
      ...
      <Switch>
        ...
        />
        <PrivateRoute
          path="/file-explorer/:caseName/:dirName/:fileName"
          component={ShowFilePage}
        />
        <PrivateRoute
          path="/file-explorer/:caseName/:dirName"
          component={CaseFilePage}
        />
        <PrivateRoute
          path="/file-explorer/:caseName"
          component={CaseDirsPage}
        />
        <PrivateRoute
          path="/task/finished"
          exact
        ...
        <PrivateRoute
          path="/extracted-cases"
          exact
          component={ExtractedCasesPage}
        />
        <PrivateRoute
          path="/common/Case1/Case2"
          exact
