      ...
      <nav>
        {auth.isAuthenticated ? (
          ...
          <>
            ...
            <Link
              onClick={(e) =>
                window.open("https://github.com/scorelab/OpenMF/")
              }
              variant="button"
              color="textPrimary"
      ...
      {!auth.isAuthenticated ? (
        <>
          ...
          <Dialog open={openLogin} aria-labelledby="login-form" scroll="body">
            ...
            <DialogActions>
              <Button onClick={handleCloseLogin} color="primary" disableRipple>
                Cancel
              </Button>
            </DialogActions>
          </Dialog>
          ...
          <Dialog open={openSignUp} aria-labelledby="signup-form" scroll="body">
            ...
            <DialogActions>
              <Button onClick={handleCloseSignUp} color="primary" disableRipple>
                Cancel
              </Button>
            </DialogActions>
          </Dialog>
